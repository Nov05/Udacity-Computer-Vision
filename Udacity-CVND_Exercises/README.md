...
3. Install PyTorch and torchvision; this should install the latest version of PyTorch.
	...
	Nov05:    
	Miniconda https://pytorch.org/ `conda install pytorch torchvision cudatoolkit=10.1 -c pytorch`   
	Or [Install Pytorch GPU by Anaconda](http://makang.fun/2019/09/13/Install-Pytorch-GPU-by-Anaconda/) `conda install pytorch torchvision cudatoolkit`   
	Then run the following code to verify:   
	```
	python   
	import torch   
...
```
Nov05: `pip install opencv-python jupyter matplotlib pandas scipy`    
